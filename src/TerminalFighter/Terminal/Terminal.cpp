...
void Terminal::draw(I_GraphicsHandler& graphics) {
    ...
    graphics.draw(terminal_texture_, (int)x_pos(), (int)y_pos(), GraphicPriority::UI, true, 0, NULL);
    graphics.draw(UIText, (int)x_pos() + 30, (int)y_pos() + 30, GraphicPriority::UI, false, 0, NULL);
