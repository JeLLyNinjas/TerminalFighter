...
class AutoTurretTargetingSystem():
...
class AutoTurretProjectile(GameObject):
...
class AutoTurret():
    ...
    def __init__(self, universe, DRAWING_SCALE):
        ...
        self.NAME_ = "Auto Turret"
        self.targeting_system = AutoTurretTargetingSystem(universe, DRAWING_SCALE)
