...
void MainMenu::update() {
    if (current_selection_ == Options::START) {
        options_[Options::START]->set_color(TF_Colours::WHITE);
        options_[Options::QUIT]->set_color(TF_Colours::GRAY);
    } else if (current_selection_ == Options::QUIT){
        options_[Options::START]->set_color(TF_Colours::GRAY);
        options_[Options::QUIT]->set_color(TF_Colours::WHITE);
    }
}
